  ...
  render() {
    return (
      <div className="stats col-md-12 row">
        {this.state.data.map((stat, k) => <div key={k} className="col-md-3 col-sm-6 col-12"><StatCard name={stat.name} ico={stat.ico} newData={stat.newData} oldData={stat.oldData} /></div>)}
      </div>
    )
